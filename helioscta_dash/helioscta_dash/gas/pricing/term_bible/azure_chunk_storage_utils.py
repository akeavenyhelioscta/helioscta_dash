...
load_dotenv()
AZURE_CHUNK_STORAGE_CONNECTION_STRING=os.getenv("AZURE_CHUNK_STORAGE_CONNECTION_STRING")
AZURE_CHUNK_STORAGE_ACCOUNT_NAME=os.getenv("AZURE_CHUNK_STORAGE_ACCOUNT_NAME")
AZURE_CHUNK_STORAGE_CONTAINER_NAME=os.getenv("AZURE_CHUNK_STORAGE_CONTAINER_NAME")

"""
"""

class AzureChunkStorageClient:
    """Client for Azure Blob Storage operations."""
    
    def __init__(
        self,
        connection_string: str = AZURE_CHUNK_STORAGE_CONNECTION_STRING,
        storage_account_name: str = AZURE_CHUNK_STORAGE_ACCOUNT_NAME,
        container_name: str = AZURE_CHUNK_STORAGE_CONTAINER_NAME,
    ):
